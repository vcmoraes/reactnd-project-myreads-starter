...
class BooksApp extends React.Component {
  ...
  componentDidMount() {
    BooksAPI.getAll().then(booksAll => {
      const readingBooks = booksAll.filter(
        book => book.shelf === "currentlyReading"
      );
      console.log("READINGS_BOOKS", readingBooks);

      const wantReadBooks = booksAll.filter(
        book => book.shelf === "wantToRead"
      );
      console.log("WANT_READ_BOOKS", wantReadBooks);

      const readBooks = booksAll.filter(book => book.shelf === "read");
      console.log("READ_BOOKS", readBooks);
    });
  }
